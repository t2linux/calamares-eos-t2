        ...
        Column {
            ...
            Rectangle {
                ...
                Text {
                    ...
                    text[de]: qsTr("Bitte wähle eine <strong>Bootloader</strong> Option für diese Installation aus, oder belasse die bereits ausgewählte Standardoption <strong>Systemd-boot</strong>.")
                    font.pointSize: 11
                    color: "#ffffff"
